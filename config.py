...
def parse_option():
    ...
    parser.add_argument("--mode", type=str, choices=["bml", "global", "local","supCon"], default="bml")
    ...
    parser.add_argument("--latent_dim", type=int, default=128)  # super contrastive latent space dimension
    parser.add_argument("--temp", type=float, default=0.1)  # contrastive loss temp
    # continue train
    ...
    assert (opt.transform == "A" and opt.dataset == "miniImageNet") or \
           (opt.transform == "S" and opt.dataset == "miniImageNet") or \
